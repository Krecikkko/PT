...
namespace Shop.Data.Test
{
    ...
    public class DataUnitTest
    {
        ...
        public void CatalogTests()
        {
            ...
            Assert.IsNotNull(repo.GetAllCatalogs());
        ...
        public void EventTests()
        {
            ...
            Assert.IsTrue(repo.GetAllEvents().Count() == 1);
            repo.RemoveEvent(1);
            repo.RemoveState(1);
            repo.RemoveCatalog(1);
            repo.RemoveUser(1);
            Assert.IsTrue(repo.GetAllEvents().Count() == 0);
        }
        ...
        public void StateTests()
        {
            ...
            Assert.IsTrue(repo.GetState(1).CatalogId == 1);
            Assert.IsTrue(repo.GetState(1).Quantity == 5);
            Assert.IsNotNull(repo.GetAllStates());
